      ...
      <div class="d-flex justify-content-center align-items-center w-100 h-100">
        <div class="row g-0">
          ...
          <div class="col-12" style="text-align: center;">
            <p style="text-align: justify;"> La carrera de Ingeniería Mecanica pertenece al
...
<div class="p-4 text-center">
  ...
  <p>Daniela Castro Rodriguez, Nancy Daniela Mendez Arpidez, 
    Gabriel Escobar Medina, Marco Gabriel Cortés Toledo y Yelitza Magali Rosas Jiménez</p>
</div>
